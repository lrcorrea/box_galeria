...
class Excursoes extends CI_Controller {

	public $nomeLista = "listaexcursoes"; // nome do view  de listagem
	public $nomeModel = "excursoes_model"; // nome do model
	public $nomeForm = "excursoes";        // nome da view de cadastro
	public $nomeAltera = "alterar_excursoes"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_excursoes"; // nome da tabela de foto
	public $idFoto = "id_excursoes";       // nome do campo da tabela de foto
	public $dentroDados = "excursoes";     // nome que vai nos dados_
	public $nomeController = "excursoes"; // nome do controlador
        ...
        if ($this->form_validation->run() == FALSE || $jaexiste == true) {  // Valida se os campos estao preenchidos e verifica se a foto ja existe
            ...
            $this->formcad($erro); // se o erro n for da foto chama o metodo sem o parametro de erro
                   ...
                   // TIAGO TESTE
                    ...
                    $config['allowed_types'] = 'gif|jpg|png|rar'; // by extension, will check for whether it is an image
                    ...
                    $data['saida_de']  = $this->input->post('saida_de');
                    $data['roteiro']  = $this->input->post('roteiro');
                    $data['incluso']  = $this->input->post('incluso');
                    $data['investimento']  = $this->input->post('investimento');
