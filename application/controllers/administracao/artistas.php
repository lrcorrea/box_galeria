...
class Artistas extends CI_Controller {
	...
	public $nomeLista = "listaartistas"; // nome do view  de listagem
	public $nomeModel = "artistas_model"; // nome do model
	public $nomeForm = "artistas";        // nome da view de cadastro
	public $nomeAltera = "alterar_artistas"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_artistas"; // nome da tabela de foto
	public $idFoto = "id_artistas";       // nome do campo da tabela de foto
	public $dentroDados = "artistas";     // nome que vai nos dados_
	public $nomeController = "artistas"; // nome do controlador
