...
class Bairro extends CI_Controller {
	...
	public $nomeLista = "listabairro"; // nome do view  de listagem
	public $nomeModel = "bairro_model"; // nome do model
	public $nomeForm = "bairro";        // nome da view de cadastro
	public $nomeAltera = "alterar_bairro"; // nome da view de alterar
	public $temFoto = true;
	public $tabelaFoto = "fotos_bairro"; // nome da tabela de foto
	public $idFoto = "id_bairro";       // nome do campo da tabela de foto
	public $dentroDados = "bairro";     // nome que vai nos dados_
	public $nomeController = "bairro"; // nome do controlador
