...
<section class="conteudo">
	<div class="bg_sobre">
			<h1>BOX GALERIA</h1>
			<h3>SOLUÇÃO CRIATIVA PARA AS ARTES VISUAIS</h3>
			<h2>PROJETO BOX GALERIA LEVA EXPOSIÇOES EM<br/>FORMATO ITINERANTE A BAIRROS DE SALVADOR</h2>
		</div>
	<div class="centro">
		
		<p>A partir do mês de julho de 2015, Salvador será sede de um projeto inovador. O Box Galeria vai fazer circular pela cidade exposições itinerantes que acontecerão dentro de conteineres, que se deslocam pelos bairros periféricos da capital. Considerando o baixo número de galerias de arte em Salvador, além do fato de elas estarem, em sua maioria, nas regiões mais centrais, o projeto busca não só a descentralização, mas a ampliação do acesso a novos artistas visuais. 
<br /><br />
Através de convocatória, artistas serão convidados a expor nas galerias móveis, que passarão pela curadoria dos artistas Mario Britto e Dervanier Hembadoom. A ideia é que apresentem propostas que dialoguem com o formato da exposição em contêiner, e que de alguma forma se envolva com a região na qual a galeria vai circular. Serão cinco exposições, que ficarão abertas à visitação pública durante um mês. Os bairros que recebem a galeria são Cajazeiras, Plataforma, Cabula, Ribeira e Liberdade, onde também acontecerão oficinas promovidas pelos artistas em exposição, além de visitas guiadas.
<br /><br />
