...
$(document).ready(function(){
	...
	<?php foreach($bairros as $integrante): ?>
...
<section class="conteudo">
	<div class="bg_sobre">
		<h1>BAIRROS</h1>
		<h3>Confira os bairros por onde irá passar o projeto</h3>
			
		<div class="centro">
			<?php 
			if($bairros){
			foreach($bairros as $integrante): 
				$this->db->where("id_bairro",$integrante->id);
			$foto = $this->db->get("fotos_bairro")->result();
				?>
