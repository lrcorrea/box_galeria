...
--
-- Host: 127.0.0.1
-- Generation Time: 29-Abr-2015 às 18:20
...
('9494267f97c26201ee7bd6c2364b21d6', '0.0.0.0', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', 1430311543, 'a:4:{s:12:"nome_usuario";s:5:"admin";s:7:"usuario";s:5:"admin";s:10:"usuario_id";s:1:"6";s:8:"loggedin";b:1;}'),
('d668b7ef65218343a34c0b33b6058b4b', '0.0.0.0', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/53', 1430318635, '');
...
CREATE TABLE IF NOT EXISTS `programacao` (
  ...
  `local` varchar(255) NOT NULL,
  `per_visi` varchar(255) NOT NULL,
  `atividades` varchar(255) NOT NULL,
  `visi_gui` varchar(255) NOT NULL,
  `oficinas` varchar(255) NOT NULL,
...
INSERT INTO `programacao` (`id`, `cidade`, `data_inicio`, `local`, `per_visi`, `atividades`, `visi_gui`, `oficinas`, `data_fim`) VALUES
(1, 'asdasd', '2015-04-29', 'asdasd', 'asdasd', 'asdasd', 'asdasd', 'asdasd', '2015-04-29'),
(2, 'asdasd', '2015-04-29', 'asd', 'asdasd', 'aasdasd', 'asd', 'asdasdas', '2015-04-29'),
(3, 'asdasd', '2015-05-07', 'asdasd', 'asdasd', 'asdasd', 'asdasdasdasd', 'asdasda', '2015-05-23');
